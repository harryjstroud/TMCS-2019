...
If you are really stuck, then there is an example completed script available to read in [drawTriangle-refactor1.py](1a/drawTriangle-refactor1.py).
...
If you are hopelessly stuck, then there is an example script available in [1c/drawTwoTriangles.py](../python/1c/drawTwoTriangles.py)

# [Next](../python/2_functions_and_modules.md)
